...
def add_column(table: "pyarrow.Table", name: str, values: "pyarrow.Array", position: int = 0) -> "pyarrow.Table":
...
def scale_logtime(table: "pyarrow.Table", log_time_column_name: str, to_unit: TimeUnit) -> "pyarrow.Table":
    """
    ...
    timestamp_values: "pyarrow.Array" = table.column(log_time_column_name).combine_chunks()
    ...
    timestamps_scaled: "pyarrow.Array" = pc.divide_checked(timestamp_values, divisor).cast(
        pa.decimal128(MAX_64_BIT_INT_PRECISION, multiplier_scale)
    )
