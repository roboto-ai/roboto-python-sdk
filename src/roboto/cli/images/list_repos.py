...
def list_repos(args: argparse.Namespace, context: CLIContext, parser: argparse.ArgumentParser) -> None:
...
ls_repos_command = RobotoCommand(
    ...
    command_kwargs={"help": "List image repositories hosted in Roboto's image registry."},
)
